package earth.tiangong.footprint.backend.security;
...
import earth.tiangong.footprint.backend.security.filter.JwtAuthenticationTokenFilter;
import earth.tiangong.footprint.backend.security.impl.AuthenticationEntryPointImpl;
import earth.tiangong.footprint.backend.security.impl.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                // .antMatchers("/home/ok", "/user/login", "/user/register", "/user/captchaImage").anonymous()
                // 静态资源，可匿名访问
